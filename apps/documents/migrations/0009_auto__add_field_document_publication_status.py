...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Document.publication_status'
        db.add_column('documents_document', 'publication_status',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Document.publication_status'
        db.delete_column('documents_document', 'publication_status')
    ...
    models = {
        'documents.document': {
            ...
            'publication_status': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1'}),
