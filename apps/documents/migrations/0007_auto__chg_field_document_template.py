...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Document.template'
        db.alter_column('documents_document', 'template', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Document.template'
        db.alter_column('documents_document', 'template', self.gf('django.db.models.fields.TextField')(default=''))
